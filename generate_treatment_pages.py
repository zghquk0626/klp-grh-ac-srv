...
<nav id="nav">
  ...
  <ul class="nav-links">
    ...
    <li><a href="#" onclick="openQuiz();return false;" data-i18n="nav_quiz">Treatment Quiz</a></li>
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <ul>
    ...
    <li><a href="#" onclick="toggleMobileMenu();openQuiz();return false;" data-i18n="nav_quiz">Treatment Quiz</a></li>
...
<header class="hero" style="background-image:url('../{t["img"]}');background-size:cover;background-position:center;min-height:50vh;display:flex;align-items:center;">
  <div class="hero-content" style="max-width:700px;padding:80px 24px 40px;">
    ...
    <a href="https://wa.me/6287736386388?text=Saya%20tertarik%20dengan%20treatment%20{t["slug"].replace("-","%20")}%20di%20Revolushine%2C%20apakah%20bisa%20konsultasi%3F" class="btn-book-hero" target="_blank" style="display:inline-block;margin-top:20px;background:#25d366;color:#fff;padding:14px 32px;border-radius:50px;font-weight:600;text-decoration:none;">Konsultasi via WhatsApp</a>
  </div>
</header>
...
<section class="section" style="padding:40px 24px;text-align:center;">
  ...
  <a href="https://wa.me/6287736386388?text=Saya%20tertarik%20dengan%20treatment%20{t["slug"].replace("-","%20")}%20di%20Revolushine%2C%20apakah%20bisa%20konsultasi%3F" class="btn-book-hero" target="_blank" style="display:inline-block;background:#25d366;color:#fff;padding:14px 32px;border-radius:50px;font-weight:600;text-decoration:none;">Konsultasi via WhatsApp</a>
</section>
...
<footer>
  <div class="foot-grid">
    ...
    <div class="foot-col">
      <h5 data-i18n="foot_nav_h">Jelajahi</h5>
...
<div class="quiz-overlay" id="quizOverlay" data-lenis-prevent>
  <button class="qclose" onclick="closeQuiz()">&#10005;</button>
  <div class="qmodal">
    <div class="qprogress">
    ...
    <div class="qresult" id="qresult">
      ...
      <a id="resWA" href="https://wa.me/6287736386388?text=Saya%20melihat%20treatment%20wajah%20dari%20website%20Revolushine%2C%20apakah%20bisa%20konsultasi%20terlebih%20dahulu%3F" class="btn-primary" target="_blank" data-i18n="nav_book">Konsultasi Sekarang</a>
...
<script>
(function() {{
  const data = treatmentData[{t["idx"]}];
  ...
  container.innerHTML = d.items.map(item => `
    <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
      <h3 style="font-size:18px;margin:0 0 8px;color:#333;">${{item.name}}</h3>
      <p style="margin:0;color:#666;line-height:1.6;">${{item.desc}}</p>
    </div>
  `).join('');
}})();
</script>
