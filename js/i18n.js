...
const translations = {
  en: {
    ...
    testi1_treat: 'Aesthetic Clinic Revolushine',
    ...
    testi3_treat: 'Aesthetic Clinic Revolushine',
    ...
    testi8_treat: 'Aesthetic Clinic Revolushine',
    ...
    testi9_treat: 'Aesthetic Clinic Revolushine',
    about_tagline: 'Our Doctor',
    about_creds: 'Board-Certified Aesthetic Physician',
    about_p1: 'Aesthetic Clinic Revolushine was built to bridge the gap between clinical excellence and heartfelt care. Led by Dr. Yoanita, we provide a sanctuary where your concerns are heard, and treatments are meticulously customized.',
    ...
    faq1_q: 'What treatments does Aesthetic Clinic Revolushine offer?',
    faq1_a: 'Aesthetic Clinic Revolushine offers a comprehensive range of aesthetic treatments including Botox, Rejuvenation, Dermal Filler (lips, temples, cheeks & chin), LIFU Face & Neck, Skinbooster, Subsisi, Medical Facial, Peeling, Diamond Silk, Hair Plasma, Korean Facial, and more — all tailored by Dr. Yoanita to your unique skin profile and goals.',
    ...
    faq7_q: 'How do I book a consultation or appointment?',
    faq7_a: 'It\'s easy: send a WhatsApp message to +62 877-3638-6388 with your concern or the treatment you\'re interested in, and our team will help schedule your free first consultation with Dr. Yoanita.',
    faq8_q: 'Where is the clinic located?',
    faq8_a: 'Aesthetic Clinic Revolushine is located at Plaza Graha Famili, Jl. Mayjend. Jonosewojo D-3A, Dukuhpakis, Surabaya. We\'re open Monday to Saturday, 09:00 – 20:00 WIB.',
  ...
  id: {
    ...
    t_view_detail: 'Lihat Halaman Lengkap',
    ...
    about_p1: 'Aesthetic Clinic Revolushine dibangun untuk menjembatani kesenjangan antara keunggulan klinis dan kepedulian yang tulus. Dipimpin oleh Dr. Yoanita, kami menyediakan ruang di mana kekhawatiranmu didengar dan perawatan dirancang khusus untukmu.',
    ...
    faq1_q: 'Treatment apa saja yang tersedia di Aesthetic Clinic Revolushine?',
    faq1_a: 'Aesthetic Clinic Revolushine menawarkan berbagai perawatan estetika termasuk Botox, Rejuvenasi, Dermal Filler (bibir, pelipis, pipi & dagu), LIFU Face & Neck, Skinbooster, Subsisi, Medical Facial, Peeling, Diamond Silk, Hair Plasma, Korean Facial, dan lainnya \u2014 semua disesuaikan oleh Dr. Yoanita dengan kebutuhan kulitmu.',
    ...
    faq7_q: 'Bagaimana cara booking konsultasi atau appointment?',
    faq7_a: 'Mudah sekali: kirim pesan WhatsApp ke +62 877-3638-6388 berisi keluhan atau treatment yang kamu inginkan, dan tim kami akan membantu menjadwalkan konsultasi pertamamu yang gratis bersama Dr. Yoanita.',
    faq8_q: 'Di mana lokasi klinik Aesthetic Clinic Revolushine?',
    faq8_a: 'Aesthetic Clinic Revolushine berlokasi di Plaza Graha Famili, Jl. Mayjend. Jonosewojo D-3A, Dukuhpakis, Surabaya. Kami buka setiap Senin sampai Sabtu pukul 09.00 – 20.00 WIB.',
